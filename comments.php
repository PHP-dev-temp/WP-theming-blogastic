...
<div class="row">
	<div id="comments" class="comments-area col-xs-10 col-xs-offset-1">
	...
	?>	
		...
		<h2 class="comment-title">
			<?php				
				printf(
					esc_html(_nx('One comment on &ldquo;%2$s&rdquo;', '%1$s comments on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'blogastictheme')),
		...
		?>			 
			 <p class="no-comments"><?php esc_html_e('Comments are closed.', 'blogastictheme'); ?></p>			 
		<?php
			endif;
		?>		
	<?php	
